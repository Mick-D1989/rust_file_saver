...
pub async fn save_single_file(directory: &Path, file_name: String, content: Vec<u8>) -> Result<(), String> {
...
#[pyfunction]
pub fn save_files(directory: &str, files: &PyList) -> PyResult<()> {
...
#[pymodule]
pub fn file_saver_rust(_py: Python, m: &PyModule) -> PyResult<()> {
